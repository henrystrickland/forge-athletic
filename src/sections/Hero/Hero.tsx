    ...
    <Section ref={ref} fullBleed id="hero" className="relative h-screen overflow-hidden">
      <div className="absolute inset-0 z-0">
        {content.background.type === "image" && (
          <img src={content.background.src} alt="" className="h-full w-full object-cover" />
        )}
      ...
      >
        {content.eyebrow && (
          <motion.p
            ...
            className="mb-6 text-sm uppercase tracking-[0.25em] text-primary"
          >
            {content.eyebrow}
          </motion.p>
        )}
        ...
        {content.cta && (
          <motion.a
            ...
            className="mt-10 rounded-full bg-primary px-8 py-3 text-sm font-medium text-black transition-transform hover:scale-105"
          >
            {content.cta.label}
          </motion.a>
        )}
